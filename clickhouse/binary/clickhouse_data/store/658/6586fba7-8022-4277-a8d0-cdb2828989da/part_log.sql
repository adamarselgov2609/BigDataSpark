ATTACH TABLE _ UUID 'd48366df-fc5e-4da2-9bce-1c680cbdd9af'
(
    ...
    `part_storage_type` String COMMENT 'The type of DataPartStorage. Possible values: Packed - all files are stored in a single blob, Full - a blob per file.',
