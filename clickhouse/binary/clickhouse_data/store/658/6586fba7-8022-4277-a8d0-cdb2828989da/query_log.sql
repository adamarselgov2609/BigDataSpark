ATTACH TABLE _ UUID '299b1d3e-d37a-498c-9c21-1ed18b69d937'
(
    ...
    `connection_address` IPv6 COMMENT 'The client IP address from which connection was made.',
    `connection_port` UInt16 COMMENT 'The client port from which connection was made.',
