ATTACH TABLE _ UUID '07550a3a-baa1-4ef2-9c00-7dd00586a48c'
(
    ...
    `ProfileEvent_IcebergMetadataFilesCacheStaleMisses` UInt64 COMMENT 'Number of times iceberg metadata files have been found in the cache, but were considered stale and had to be read from (remote) disk.',
    ...
    `ProfileEvent_ParquetMetadataCacheHits` UInt64 COMMENT 'Number of times parquet metadata has been found in the cache.',
    `ProfileEvent_ParquetMetadataCacheMisses` UInt64 COMMENT 'Number of times parquet metadata has not been found in the cache and had to be read from disk.',
    `ProfileEvent_ParquetMetadataCacheWeightLost` UInt64 COMMENT 'Approximate number of bytes evicted from the parquet metadata cache.',
    ...
    `ProfileEvent_TextIndexTokensCacheHits` UInt64 COMMENT 'Number of times a text index token info has been found in the cache.',
    `ProfileEvent_TextIndexTokensCacheMisses` UInt64 COMMENT 'Number of times a text index token info has not been found in the cache.',
    ...
    `ProfileEvent_DiskObjectStorageWaitBlobRemovalMicroseconds` UInt64 COMMENT 'Time spent waiting for pending blob removal after committing metadata transaction',
    ...
    `ProfileEvent_DictCacheLockWriteHoldNs` UInt64 COMMENT 'Number of nanoseconds spent holding write lock for the dictionaries of \'cache\' types.',
    ...
    `ProfileEvent_DictCacheLockReadHoldNs` UInt64 COMMENT 'Number of nanoseconds spent holding read lock for the dictionaries of \'cache\' types.',
    ...
    `ProfileEvent_KeeperPreprocessElapsedMicroseconds` UInt64 COMMENT 'Keeper preprocessing latency for a single request',
    `ProfileEvent_KeeperStorageLockWaitMicroseconds` UInt64 COMMENT 'Time spent waiting for acquiring Keeper storage lock',
    `ProfileEvent_KeeperStorageLockHoldMicroseconds` UInt64 COMMENT 'Time spent holding Keeper storage lock',
    `ProfileEvent_KeeperStorageSharedLockWaitMicroseconds` UInt64 COMMENT 'Time spent waiting for acquiring Keeper storage shared lock',
    `ProfileEvent_KeeperStorageSharedLockHoldMicroseconds` UInt64 COMMENT 'Time spent holding Keeper storage shared lock',
    `ProfileEvent_KeeperChangelogLockWaitMicroseconds` UInt64 COMMENT 'Time spent waiting for acquiring Keeper changelog lock',
    `ProfileEvent_KeeperChangelogLockHoldMicroseconds` UInt64 COMMENT 'Time spent holding Keeper changelog lock',
    `ProfileEvent_KeeperServerWriteLockWaitMicroseconds` UInt64 COMMENT 'Time spent waiting for acquiring Keeper server write lock',
    `ProfileEvent_KeeperServerWriteLockHoldMicroseconds` UInt64 COMMENT 'Time spent holding Keeper server write lock',
    `ProfileEvent_KeeperSessionCallbackLockWaitMicroseconds` UInt64 COMMENT 'Time spent waiting for acquiring Keeper session callback lock',
    `ProfileEvent_KeeperSessionCallbackLockHoldMicroseconds` UInt64 COMMENT 'Time spent holding Keeper session callback lock',
    `ProfileEvent_KeeperReadRequestQueueLockWaitMicroseconds` UInt64 COMMENT 'Time spent waiting for acquiring Keeper read request queue lock',
    `ProfileEvent_KeeperReadRequestQueueLockHoldMicroseconds` UInt64 COMMENT 'Time spent holding Keeper read request queue lock',
    `ProfileEvent_KeeperProcessAndResponsesLockWaitMicroseconds` UInt64 COMMENT 'Time spent waiting for acquiring Keeper process and responses lock',
    `ProfileEvent_KeeperProcessAndResponsesLockHoldMicroseconds` UInt64 COMMENT 'Time spent holding Keeper process and responses lock',
    ...
    `ProfileEvent_KeeperStaleRequestsSkipped` UInt64 COMMENT 'Number of Keeper requests skipped because the session is no longer live',
    `ProfileEvent_KeeperLiveSessionsLockWaitMicroseconds` UInt64 COMMENT 'Time spent waiting to acquire Keeper live sessions lock',
    `ProfileEvent_KeeperLiveSessionsLockHoldMicroseconds` UInt64 COMMENT 'Time spent holding Keeper live sessions lock',
    ...
    `ProfileEvent_ObjectStorageListedObjects` UInt64 COMMENT 'Total objects returned by object storage listing API before any filtering.',
    `ProfileEvent_ObjectStorageGlobFilteredObjects` UInt64 COMMENT 'Objects that did not match the glob or regex pattern and were skipped during listing.',
    `ProfileEvent_ObjectStoragePredicateFilteredObjects` UInt64 COMMENT 'Objects removed by virtual column predicate filtering on _path/_file.',
    `ProfileEvent_ObjectStorageReadObjects` UInt64 COMMENT 'Objects actually opened for reading by the object storage source.',
    ...
    `ProfileEvent_SharedMergeTreeSelectPartsForRendezvousFetchMicroseconds` UInt64 COMMENT 'Time of selectPartsForRendezvousFetch',
    `ProfileEvent_SharedMergeTreeSelectPartsForRendezvousFetchParts` UInt64 COMMENT 'Number of parts selected by selectPartsForRendezvousFetch',
    `ProfileEvent_SharedMergeTreeSelectPartsForCoordinatedFetchMicroseconds` UInt64 COMMENT 'Time of selectPartsForCoordinatedFetch',
    `ProfileEvent_SharedMergeTreeSelectPartsForCoordinatedFetchParts` UInt64 COMMENT 'Number of parts selected by selectPartsForCoordinatedFetch',
    `ProfileEvent_SharedMergeTreeSelectPartsForFullFetchMicroseconds` UInt64 COMMENT 'Time of selectPartsForFullFetch',
    `ProfileEvent_SharedMergeTreeSelectPartsForFullFetchParts` UInt64 COMMENT 'Number of parts selected by selectPartsForFullFetch',
    ...
    `ProfileEvent_SharedMergeTreeReplicaSetUpdatesFromZooKeeper` UInt64 COMMENT 'How many times we have update replica set from ZooKeeper',
    `ProfileEvent_SharedMergeTreeReplicaSetUpdatesFromZooKeeperRequests` UInt64 COMMENT 'How many total ZooKeeper requests we made to update replica set',
    `ProfileEvent_SharedMergeTreeReplicaSetUpdatesFromZooKeeperMicroseconds` UInt64 COMMENT 'How much time we spend to update replica set',
    ...
    `ProfileEvent_WasmSerializationMicroseconds` UInt64 COMMENT 'Time spent executing WebAssembly code',
    `ProfileEvent_WasmDeserializationMicroseconds` UInt64 COMMENT 'Time spent executing WebAssembly code',
    `ProfileEvent_WasmGuestExecuteMicroseconds` UInt64 COMMENT 'Time spent executing WebAssembly code',
    `ProfileEvent_WasmTotalExecuteMicroseconds` UInt64 COMMENT 'Time spent executing WebAssembly code',
    `ProfileEvent_WasmModuleInstatiate` UInt64 COMMENT 'Number of WebAssembly compartments created',
    `ProfileEvent_WasmMemoryAllocated` UInt64 COMMENT 'Total memory allocated for WebAssembly compartments',
    ...
    `ProfileEvent_DistributedConnectionConnectCount` UInt64 COMMENT 'Number of connects to other servers done during distributed query execution. Happens when new connection is established instead of using existing from pool.',
    ...
    `CurrentMetric_MaxAllocatedEphemeralLockSequentialNumber` Int64 COMMENT 'The maximum sequential number allocated for ephemeral lock znodes in ZooKeeper. Primarily influenced by the block numbers.',
    ...
    `CurrentMetric_IcebergSchedulePoolTask` Int64 COMMENT 'Number of tasks in the background schedule pool for Iceberg tables.',
    `CurrentMetric_IcebergSchedulePoolSize` Int64 COMMENT 'Limit on number of tasks in the background schedule pool for Iceberg tables.',
    ...
    `CurrentMetric_ParquetMetadataCacheBytes` Int64 COMMENT 'Size of the Parquet metadata cache in bytes',
    `CurrentMetric_ParquetMetadataCacheFiles` Int64 COMMENT 'Number of cached files in the Parquet metadata cache',
    ...
    `CurrentMetric_TextIndexTokensCacheBytes` Int64 COMMENT 'Size of the text index tokens cache in bytes',
    `CurrentMetric_TextIndexTokensCacheCells` Int64 COMMENT 'Number of entries in the text index tokens cache',
    ...
    `CurrentMetric_MergeTreeSnapshotCommitThreads` Int64 COMMENT 'Number of threads used to commit snapshot',
    `CurrentMetric_MergeTreeSnapshotCommitThreadsActive` Int64 COMMENT 'Number of active threads used to commit snapshot',
    `CurrentMetric_MergeTreeSnapshotCommitThreadsScheduled` Int64 COMMENT 'Number of scheduled threads used to commit snapshot',
